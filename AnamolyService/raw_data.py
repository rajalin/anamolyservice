...
KINESIS_DATA_STREAM = "m03p02_raw_data_streamdev"

kinesis_handle = boto3.client('kinesis', region_name = "us-east-1", endpoint_url='arn:aws:kinesis:us-east-1:054922091883:stream/m03p02_raw_data_streamdev')
...
def publishDummyData(loopCount):
	message = {}
	value = float(random.normalvariate(97.5, 2))
	value = round(value, 1)
	timestamp = str(datetime.datetime.now())
	message['d_timestamp'] = str(timestamp)
	message['datatype'] = 'Temperature'
	message['value'] = value
	message['deviceid'] = "DHT_001"
	message['d_date'] = str(today)
	message['lowest_temp'] = 95
